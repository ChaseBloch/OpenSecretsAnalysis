...
summary(med.rep_dis)
#summary(medsens_rep)
pdf(file = 'FinalScripts&Figures/MediationRepDisIranv2.pdf')
...
summary(med.amb_dis)
pdf(file = 'FinalScripts&Figures/MediationCertDisIranv2.pdf')
par(mar = c(4.1, 4.4, 4.1, 1.9), xaxs="i", yaxs="i")
plot(med.amb_dis)
dev.off()
...
summary(med.ins_dis)
pdf(file = 'FinalScripts&Figures/MediationInsDisIranv2.pdf')
par(mar = c(4.1, 4.4, 4.1, 1.9), xaxs="i", yaxs="i")
plot(med.ins_dis)
dev.off()
...
summary(med.rep_dem)
pdf(file = 'FinalScripts&Figures/MediationRepDemIranv2.pdf')
par(mar = c(4.1, 4.4, 4.1, 1.9), xaxs="i", yaxs="i")
plot(med.rep_dem)
dev.off()
...
summary(med.amb_dem)
pdf(file = 'FinalScripts&Figures/MediationCertDemIranv2.pdf')
par(mar = c(4.1, 4.4, 4.1, 1.9), xaxs="i", yaxs="i")
plot(med.amb_dem)
dev.off()
...
summary(med.ins_dem)
pdf(file = 'FinalScripts&Figures/MediationInsDemIranv2.pdf')
par(mar = c(4.1, 4.4, 4.1, 1.9), xaxs="i", yaxs="i")
plot(med.ins_dem)
dev.off()
##########################
...
write(med_table, "FinalScripts&Figures/med_table_iran_v2.html")
BROWSE("FinalScripts&Figures/med_table_iran_v2.html")
